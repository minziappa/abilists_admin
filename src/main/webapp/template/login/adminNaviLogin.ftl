			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu">
					...
					<li class="divider"></li>
					<li><a href="/admin/login/logout"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span> <@spring.message "login.sign.out"/><span class="sr-only">(current)</span></a></li>
				</ul>
			</li>